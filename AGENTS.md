...
moon query affected                                       # what CI's `changed` job considers affected (no --base flag; always diffs against the default branch)
```
